...
namespace LibraryAPI.Identity.Infrastructure.Presentation.Filters
{
   /// <summary>
   ...
   public class DtoValidationFilter : IActionFilter
   {
      ...
      public void OnActionExecuting(ActionExecutingContext context)
      {
         ...
         //Searching action method argument which type contains Dto. E.g. UserDto
         //Actiong arguments kvp contains object like this:
         //key: user
         //value: { UserDto { userDtoFields } }
